...
let teachers = [
    ...
    { name:"د.هبة محمد ",position:"دكتور",img:"img/teachers/هبة محمد.jfif",dataFilter:".law"},
    ...
    { name:"م.أسماء أسامة",position:"معيد",img:"img/teachers/اسماء اسامة.jfif",dataFilter:".pharmacy"},
    { name:"م. مي زكريا",position:"معيد",img:"img/teachers/ف.jfif",dataFilter:".pharmacy"},
    { name:"م.محمد صلاح",position:"معيد",img:"img/teachers/محمد صلاح.jfif",dataFilter:".pharmacy"},
    { name:"د.الجعفري",position:"دكتور",img:"img/teachers/ف.jfif",dataFilter:".pharmacy"},
    { name:"م.عبير عبدالمجيد",position:"معيد",img:"img/teachers/ف.jfif",dataFilter:".pharmacy"},
    { name:"م.علياء اسماعيل عبد القادر",position:"معيد",img:"img/teachers/ف.jfif",dataFilter:".pharmacy"},
    { name:"م.ياسمين مصطفى",position:"معيد",img:"img/teachers/ف.jfif",dataFilter:".pharmacy"},
    { name:"د.نهلة حافظ",position:"معيد",img:"img/teachers/ف.jfif",dataFilter:".pharmacy"},
    { name:"م.ألاء جمال",position:"معيد",img:"img/teachers/ف.jfif",dataFilter:".pharmacy"},
    { name:"أ.سعيد مغاوري",position:"علاقات عامة",img:"img/teachers/سعيد مغاوري.jfif",dataFilter:".science"},
    { name:"أ.محمد رشيد",position:"اشراف",img:"img/teachers/محمد رشيد.jfif",dataFilter:".social-science"},
    { name:"أ.أماني",position:"مديره مكتب رئيس مجلس الاداره",img:"img/teachers/أماني.jfif",dataFilter:".social-science"},
